...
Source: Reproducible Research, Coursera
Code source: https://github.com/mGalarnyk/datasciencecoursera/tree/master/5_Reproducible_Research/project1
...
ggplot(Total_Steps, aes(x = steps)) +
    geom_histogram(fill = "light pink", binwidth = 1000) +
